...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['action'])) {
        if ($_POST['action'] === 'update_profile') {
            ...
            header('Location: ' . baseUrl('teacher/profile.php'));
            exit;
    ...
    <div class="col-4">
        ...
        <div class="card">
            ...
            <div class="card-body text-center">
                <p style="margin: 0 0 1rem 0; color: #666;">Il tuo ID univoco da condividere con gli studenti:</p>
                ...
                <p style="margin: 1rem 0 0 0; font-size: 0.85rem; color: #999;">
                    Gli studenti possono usare questo ID per trovare i tuoi corsi.
                </p>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p style="margin: 0 0 0.5rem 0;">
                    ...
                    <span class="badge badge-teacher">Docente</span>
                </p>
            ...
            <div class="card-body text-center">
                <?php if (!empty($user['profile_photo'])): ?>
                    <img
                        ...
                        alt="Foto Profilo"
                        style="width: 150px; height: 150px; border-radius: 50%; object-fit: cover; border: 3px solid var(--teacher-primary);"
                        onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';"
                    >
                    <div style="display: none; width: 150px; height: 150px; border-radius: 50%; background: var(--teacher-primary); color: white; font-size: 3rem; align-items: center; justify-content: center; margin: 0 auto;">
                        <?php echo strtoupper(substr($user['first_name'], 0, 1)); ?>
                    </div>
                <?php else: ?>
                    <div style="width: 150px; height: 150px; border-radius: 50%; background: var(--teacher-primary); color: white; font-size: 3rem; display: flex; align-items: center; justify-content: center; margin: 0 auto;">
                        <?php echo strtoupper(substr($user['first_name'], 0, 1)); ?>
                    </div>
                <?php endif; ?>
                <p style="margin: 1rem 0 0 0; font-size: 0.85rem; color: #999;">
